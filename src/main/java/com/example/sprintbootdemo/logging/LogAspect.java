package com.example.sprintbootdemo.logging;
...
public class LogAspect {
    ...
    @Around("execution(* com.example.sprintbootdemo..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.example.sprintbootdemo..*.*(..))",throwing = "ex")
